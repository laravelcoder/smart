                ...
                <ul class="cat">
                    @foreach($Categories as $Category)
                        ...
                        <li>
                            ...
                            @endif
                            <a {{ $active_cat }}
                               href="{{ route('FrontendTopicsByCat',["section"=>$Category->webmasterSection->name,"cat"=>$Category->id]) }}">{{$Category->$category_title_var}}</a><span
                                    class="pull-right">({{ count($Category->topics) }})</span></li>
                    @endforeach
                </ul>
            </div>
                ...
                <ul class="recent">
                    @foreach($TopicsMostViewed as $TopicMostViewed)
                        ...
                        <li>
                            <div class="row">
                                <div class="col-lg-12">
                                    <a href="{{route('FrontendTopic',["section"=>$TopicMostViewed->webmasterSection->name,"id"=>$TopicMostViewed->id])}}">
                                    ...
                                    <h6>
                                        <a href="{{route('FrontendTopic',["section"=>$TopicMostViewed->webmasterSection->name,"id"=>$TopicMostViewed->id])}}">{{ $side_title }}</a>
                                    </h6>
                                </div>
                            </div>
                        </li>
