...
<script src="{{ URL::to('frontEnd/js/jquery.fancybox.pack.js') }}"></script>
<script src="{{ URL::to('frontEnd/js/jquery.fancybox-media.js') }}"></script>
<script src="{{ URL::to('frontEnd/js/google-code-prettify/prettify.js') }}"></script>
<script src="{{ URL::to('frontEnd/js/portfolio/jquery.quicksand.js') }}"></script>
<script src="{{ URL::to('frontEnd/js/portfolio/setting.js') }}"></script>
<script src="{{ URL::to('frontEnd/js/jquery.flexslider.js') }}"></script>
<script src="{{ URL::to('frontEnd/js/animate.js') }}"></script>
