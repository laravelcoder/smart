            ...
            <div class="modal-dialog" id="animate">
                ...
                icons: {
                  ...
                  close: 'fa fa-remove'
                                            ...
                                            {!! Form::text('date_at',date("Y-m-d hh:mm A", strtotime($EditEvent->start_date)), array('placeholder' => '','class' => 'form-control','id'=>'date_at')) !!}
                                            <span class="input-group-addon">
                  <span class="fa fa-calendar"></span>
              </span>
                                        </div>
                ...
                icons: {
                  ...
                  close: 'fa fa-remove'
                                                ...
                                                {!! Form::text('time_start',date("Y-m-d hh:mm A", strtotime($EditEvent->start_date)), array('placeholder' => '','class' => 'form-control','id'=>'time_start')) !!}
                                                <span class="input-group-addon">
                  <span class="fa fa-calendar"></span>
              </span>
                                            </div>
                ...
                icons: {
                  ...
                  close: 'fa fa-remove'
                                                ...
                                                {!! Form::text('time_end',date("Y-m-d hh:mm A", strtotime($EditEvent->end_date)), array('placeholder' => '','class' => 'form-control','id'=>'time_end')) !!}
                                                <span class="input-group-addon">
                  <span class="fa fa-calendar"></span>
              </span>
                                            </div>
            ...
            <div class="modal-dialog" id="animate">
                ...
                icons: {
                  ...
                  close: 'fa fa-remove'
                                            ...
                                            {!! Form::text('date_at',date("Y-m-d hh:mm A"), array('placeholder' => '','class' => 'form-control','id'=>'date_at')) !!}
                                            <span class="input-group-addon">
                  <span class="fa fa-calendar"></span>
              </span>
                                        </div>
                ...
                icons: {
                  ...
                  close: 'fa fa-remove'
                                                ...
                                                {!! Form::text('time_start',date("Y-m-d hh:mm A"), array('placeholder' => '','class' => 'form-control','id'=>'time_start')) !!}
                                                <span class="input-group-addon">
                  <span class="fa fa-calendar"></span>
              </span>
                                            </div>
                ...
                icons: {
                  ...
                  close: 'fa fa-remove'
                                                ...
                                                {!! Form::text('time_end',date("Y-m-d hh:mm A"), array('placeholder' => '','class' => 'form-control','id'=>'time_end')) !!}
                                                <span class="input-group-addon">
                  <span class="fa fa-calendar"></span>
              </span>
                                            </div>
