...
<i class="material-icons">&#xe7ef;</i>
                  ...
                  <span class="nav-icon">
                    <i class="material-icons">{!! $LiIcon !!}</i>
                                        ...
                                        <span class="nav-text">{!! trans('backLang.'.$GeneralWebmasterSection->name) !!}</span>
                                    </a>
                                    <ul class="nav-sub">
                                        @if($GeneralWebmasterSection->sections_status > 0)
                                            ...
                                            <li {{ ($PathCurrentFolder==$currentFolder) ? 'class=active' : '' }} >
                                                <a href="{{ route('sections',$GeneralWebmasterSection->id) }}">
                                                    <span class="nav-text">{{ trans('backLang.sectionsOf') }} {{ trans('backLang.'.$GeneralWebmasterSection->name) }}</span>
                                                </a>
                                            </li>
                                        @endif
