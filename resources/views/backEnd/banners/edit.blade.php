            ...
            <div class="box-body">
                ...
                @if($WebmasterBanner->type!=0)
                    ...
                    <div id="files_div" style="display: {{ ($Banners->video_type == 0) ? "block" : "none" }}">
                        <div class="form-group row">
                            <label for="file_ar"
                                   class="col-sm-2 form-control-label">{!!  trans('backLang.'.$ttile) !!} {!!  trans('backLang.arabicBox') !!}</label>
                            <div class="col-sm-10">
                                @if($Banners->file_ar!="")
                                    @if($WebmasterBanner->type==1)
                                        <div class="row">
                        ...
                        <div class="form-group row">
                            <label for="file_en"
                                   class="col-sm-2 form-control-label">{!!  trans('backLang.'.$ttile) !!} {!!  trans('backLang.englishBox') !!}</label>
                            <div class="col-sm-10">
                                @if($Banners->file_en!="")
                                    @if($WebmasterBanner->type==1)
                                        <div class="row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                {!! Form::text('icon',$Banners->icon, array('placeholder' => '','class' => 'form-control icp icp-auto','id'=>'title_en', 'data-placement'=>'bottomRight')) !!}
